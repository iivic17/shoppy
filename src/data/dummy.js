...
export const EditorData = () => (
	<div>
		<h1>Try React</h1>
		<h3>
			React has been designed from the start for gradual adoption, and you can use
			as little or as much React as you need. Whether you want to get a taste of
			React, add some interactivity to a simple HTML page, or start a complex
			...
			this HTML file, edit it, and open it from the local filesystem in your
			browser. It does a slow runtime code transformation, so we’d only recommend
			using this for simple demos. Add React to a Website You can add React to an
			HTML page in one minute. You can then either gradually expand its presence, or
			keep it contained to a few dynamic widgets. Create a New React App When
			starting a React project, a simple HTML page with script tags might still be
			the best option. It only takes a minute to set up! As your application grows,
			you might want to consider a more integrated setup. There are several
			JavaScript toolchains we recommend for larger applications. Each of them can
			work with little to no configuration and lets you take full advantage of the
			rich React ecosystem. Learn how. Learn React People come to React from
			different backgrounds and with different learning styles. Whether you prefer a
			more theoretical or a practical approach, we hope you’ll find this section
			helpful. If you prefer to learn by doing, start with our practical tutorial.
			If you prefer to learn concepts step by step, start with our guide to main
			concepts. Like any unfamiliar technology, React does have a learning curve.
			With practice and some patience, you will get the hang of it. First Examples
			The React homepage contains a few small React examples with a live editor.
			Even if you don’t know anything about React yet, try changing their code and
			see how it affects the result. React for Beginners If you feel that the React
...
export const themeColors = [
	{
		class: 'bg-[#1A97F5] after:bg-[#1A97F5]',
		name: 'blue-theme',
		color: '#1A97F5',
		tooltip: 'Blue Theme',
	},
	{
		class: 'bg-[#03C9D7] after:bg-[#03C9D7]',
		name: 'green-theme',
		color: '#03C9D7',
		tooltip: 'Green Theme',
	},
	{
		class: 'bg-[#7352FF] after:bg-[#7352FF]',
		name: 'purple-theme',
		color: '#7352FF',
		tooltip: 'Purple Theme',
	},
	{
		class: 'bg-[#FF5C8E] after:bg-[#FF5C8E]',
		name: 'red-theme',
		color: '#FF5C8E',
		tooltip: 'Red Theme',
	},
	{
		class: 'bg-[#1E4DB7] after:bg-[#1E4DB7]',
		name: 'indigo-theme',
		color: '#1E4DB7',
		tooltip: 'Indigo Theme',
	},
	{
		class: 'bg-[#FB9678] after:bg-[#FB9678]',
		color: '#FB9678',
		name: 'orange-theme',
